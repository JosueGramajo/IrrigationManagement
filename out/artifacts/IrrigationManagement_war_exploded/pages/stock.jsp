                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="table-responsive table--no-card m-b-40">
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <tbody>
                                    <c:forEach var="s" items="${stocksList}">
                                        <tr>
                                            <td>
                                                <c:if test="${ s.getNombrePais() == 'GT' }">
                                                    <img src="../assets/img/guatemala.png" height="40" width="40">
                                                </c:if>
                                                <c:if test="${ s.getNombrePais() == 'US' }">
                                                    <img src="../assets/img/usa.png" height="40" width="40">
                                                </c:if>
                                            </td>
                                            <td>${s.getNombreProducto()}</td>
                                            <td>${s.getCantidad()}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
