...
<div class="container">
    ...
    <c:if test="${ state eq 'incorrect-login' }">
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            Usuario o contraseña incorrecta, trate nuevamente
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="/login">
                                    ...
                                    <div class="form-group">
                                        <input name="txtPassword" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Contraseña">
                                    </div>
                                    <div class="form-group">
