                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center title-2">Realizar venta</h3>
                                    </div>
                                    <hr>
                                    <form action="NewSaleServlet.do" method="post">
                                        <div class="form-group">
                                            <div>
                                                <label for="selectClient" class=" form-control-label">Seleccione el cliente</label>
                                            </div>
                                            <div>
                                                <select name="selectClient" id="selectClient" class="form-control-sm form-control">
                                                    <option value="0">Seleccionar</option>
                                                    <c:forEach var="c" items="${listaClientes}">
                                                        <option value="${c.getNitCliente()}">${c.getNitCliente()} - ${c.getNombreCliente()}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div>
                                                <label for="selectProduct" class=" form-control-label">Seleccione el producto</label>
                                            </div>
                                            <div>
                                                <select name="selectProduct" id="selectProduct" class="form-control-sm form-control">
                                                    <option value="0">Seleccionar</option>
                                        ...
                                        <div class="form-group">
                                            <div>
                                                <label for="selectEmployee" class=" form-control-label">Seleccione el empleado</label>
                                            </div>
                                            <div>
                                                <select name="selectEmployee" id="selectEmployee" class="form-control-sm form-control">
                                                    <option value="0">Seleccionar</option>
                                        ...
                                        <div class="form-group">
                                            <label for="price" class="control-label mb-1">Precio unitario</label>
                                        ...
                                        <div>
                                            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                ...
                                                <span id="payment-button-amount">Realizar compra</span>
